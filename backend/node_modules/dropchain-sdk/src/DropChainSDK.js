...
async validateSessionToken(session1Token, user1Uid) {
    const url = "https://api.dropchain.network/v1/validate_session_token";
    const payload = {
        app_id: this.appId,
        user1_uid: user1Uid,
        session1_token: session1Token, // needs to be included within the call
        // ...(session1Token && { session1_token: session1Token })
    };
